            ...
            >
                ...
                <form className="flex flex-col gap-5" onSubmit={handleLogin}>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded-2xl py-4 text-lg font-bold shadow-md hover:shadow-lg active:scale-[0.98] transition-all border flex justify-center items-center disabled:opacity-50"
                ...
                <div className="mt-8 text-center text-sm font-semibold" style={{ color: theme.text }}>
                    Don't have an account? <span onClick={() => navigate('/signup')} className="hover:underline font-bold cursor-pointer" style={{ color: theme.primary }}>Sign Up</span>
                </div>
